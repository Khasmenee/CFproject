        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="dateofbirth" class="col-md-4 col-form-label text-md-right">{{ __('วัน/เดือน/ปี เกิด') }}</label>

                            <div class="col-md-6">
                                <input id="dateofbirth" type="text" class="form-control @error('dateofbirth') is-invalid @enderror" name="dateofbirth" required autocomplete="dateofbirth" placeholder="00/00/0000">
                        ...
                        <div class="form-group row">
                            <label for="type" class="col-md-4 col-form-label text-md-right">{{ __('เป็น') }}</label>
                            
                            <div class="col-md-6">
                                <select id="type" class=" form-control" name = "type" required>
                                    <option value=0>บุคคลทั่วไป</option>
                                    <option value=1>บุคคลากรสถานศึกษา</option>
                                </select>
                            </div>
                            @error('type')
                                <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group row">
                                <label for="academy" class="col-md-4 col-form-label text-md-right">{{ __('ชื่อสถานศึกษา') }}</label>

                                <div class="col-md-6">
                                    <input id="academy" type="text" class="form-control @error('academy') is-invalid @enderror" name="academy" required autocomplete="academy" placeholder="บุคคลากรสถานศึกษา โปรดระบุ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="lineid" type="text" class="form-control @error('lineid') is-invalid @enderror" name="lineid" required autocomplete="lineid">
