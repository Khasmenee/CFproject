    ...
    <table class="table">
        ...
        @foreach($orders as $order)
            ...
            <tr>
                ...
                <td align="center"><a href="{{ url('/dashboard/admin/order/edit/'.$order->id) }}" class="btn btn-success"> แก้ไข </a></td>
                <td align="center"><a href="{{ url('/dashboard/admin/order/delete/'.$order->id) }}" onclick="return confirm('ต้องการที่จะลบข้อมูลนี้หรือไม่ ?')" class="btn btn-danger">ลบ</td>
            </tr>
                    @endif
                @endforeach
            @endforeach
