...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="{{url('dashboard/charts')}}"><em class="fa fa-bar-chart">&nbsp;</em> แผนภูมิ</a></li>
			<li><a href="{{url('dashboard/elements')}}"><em class="fa fa-bar-chart">&nbsp;</em> การจัดการรับคำสั่งซื้อ</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">แผนภูมิ</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">แผนภูมิ</h1>
			</div>
		</div><!--/.row-->
