...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="{{url('dashboard/widgets')}}"><em class="fa fa-calendar">&nbsp;</em>การวางแผนการจัดการ</a></li>
			<li><a href="{{url('dashboard/charts')}}"><em class="fa fa-bar-chart">&nbsp;</em> แผนภูมิ</a></li>
			<li class="active"><a href="{{url('dashboard/elements')}}"><em class="fa fa-bar-chart">&nbsp;</em>การจัดการรับคำสั่งซื้อ</a></li>
			<li><a href="{{url('dashboard/categories')}}"><em class="fa fa-bar-chart">&nbsp;</em> การจัดการหมวดหมู่สินค้า</a></li>
			<li><a href="{{url('dashboard/products')}}"><em class="fa fa-bar-chart">&nbsp;</em> การจัดการสินค้า</a></li>
			<li class="parent "><a data-toggle="collapse" href="#sub-item-3">
				<em class="fa fa-navicon">&nbsp;</em> การจัดการสินค้าที่จำหน่าย <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
				<ul class="children collapse" id="sub-item-3">
					<li><a class="" href="#">
						<span class="fa fa-arrow-right">&nbsp;</span> สมุดรับประกาศนียบัตร
					</a></li>
					<li><a class="" href="#">
						<span class="fa fa-arrow-right">&nbsp;</span> กรอบรูป
					</a></li>
					<li><a class="" href="#">
						<span class="fa fa-arrow-right">&nbsp;</span> ชุดครุย
					</a></li>
				</ul>
			</li>
			<li><a href="{{url('dashboard/panels')}}"><em class="fa fa-clone">&nbsp;</em> การตั้งค่า </a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">การจัดการรับคำสั่งซื้อ</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">การจัดการรับคำสั่งซื้อ</h1>
			</div>
		</div><!--/.row-->
